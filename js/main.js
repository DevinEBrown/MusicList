...
function init() {
    ...
    addEventListener('click', addSong, false);
    document.
    getElementById('btnDisplay').
    addEventListener('click', displayList, false);
    document.
    getElementById('btnClear').
    addEventListener('click', clearList, false);
}
...
function displayList()
{
    ...
    output += "</table>";
    document.
    getElementById('listArea').innerHTML = output;
}
